...
class CalendarSettings extends React.Component {
  ...
  checkAuth() {
    window.gapi.auth.authorize(
      {
        client_id:
          "998213442315-36am84caphfp5kve49oom63murreksr4.apps.googleusercontent.com",
  ...
  calendarSettings() {
    ...
    $(calendar).fullCalendar({
      ...
      eventClick: function(calEvent, jsEvent, view) {
        ...
        var mealDate = moment(calEvent._d)
          .add(1, "day")
          .format("MMMM Do[,] YYYY");
        context.setState({
      ...
      dayClick: function(calEvent, jsEvent, view) {
        var dateSelected = moment(calEvent._d)
          .add(1, "day")
          .format("MMMM Do");

        context.setState({
          date: moment(calEvent._d)
            .add(1, "day")
            .format("YYYY-MM-DD")
        });
  ...
  insertEvent() {
    ...
    var request = window.gapi.client.calendar.events.insert({
      calendarId: "primary",
        ...
        dateTime: this.state.date + "T" + defaultEnd,
        timeZone: "America/Los_Angeles"
      },
      start: {
        dateTime: this.state.date + "T" + this.state.mealTime,
        timeZone: "America/Los_Angeles"
      },
  ...
  getEventsOnLoad() {
    ...
    axios
      .get("/api/events", { username: context.state.username })
  ...
  getMeals() {
    ...
    axios.get("/api/meals").then(function(meals) {
  ...
  editEvent(id) {
    ...
    axios.put("/api/events", data).then(function() {
      const { calendar } = context.refs;
      $(calendar).fullCalendar("destroy");
      context.getEventsOnLoad();
    });

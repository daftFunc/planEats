    ...
    <div>
      <Panel className="recipeBookPanel">
        <div className="itemHeader item recipeHeader">
          ...
          <p className="readyIn" style={{ textAlign: "center" }}>
            Ready in {recipe.recipe.readyInMinutes} minutes!
          </p>
        </div>
        ...
        <div className="recipeImage item">
          ...
          <div className="buttonRow">
            <Button
              className="btnRL"
              bsStyle="success"
              onClick={() => displaySummary(recipe.recipe.id)}
            >
              Summary
            </Button>
            <Button
              className="btnRL"
              onClick={() => displayIngredients(recipe)}
            >
              Ingredients
            </Button>
            <Button
              className="btnRL"
              bsStyle="primary"
              onClick={() => displayInstructions(recipe)}
            >
              Instructions
            </Button>
          </div>

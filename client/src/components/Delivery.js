...
import "./Delivery.css";
import /*FieldGroup, FormGroup, HelpBlock, ControlLabel, FormControl, Button, Checkbox, Radio */ "react-bootstrap";
      ...
      <div id="deliveryContainer">
        ...
        <form id="delivery" onSubmit={this.handleSearch.bind(this)}>
          <input
            id="form"
            type="text"
            placeholder="Input address ex. 944 Market Street, San Franciso, CA"
            onChange={this.handleChange.bind(this)}
          />
          <Button type="submit" onSubmit={this.handleSearch.bind(this)}>
            Search
          </Button>
        </form>
        <div id="delivery">
          {this.state.restaurants.map(restaurant => {
            return (
              <div>
                <img src={restaurant.logoUrl} width="150" height="150" />

...
router.route("/users").post(controller.user.post);

router
  .route("/getEventRecipes")
...
router.route("/searchRestaurants").post(function(req, res) {
  curl.request(
    {
      url:
        "https://api.eatstreet.com/publicapi/v1/restaurant/search?method=both&street-address=" +
        req.body.location,
